...
namespace cte {
    class DocumentData {
        QList<Symbol> text_;
        int site_id_user_;                          // assigned to the client
    ...
    public:
        DocumentData();
        DocumentData(int site_id_user, const QString& sharing_link);
        DocumentData(const QList<Symbol>& text, int site_id_user, const QHash<QString,int>& site_id_others,
