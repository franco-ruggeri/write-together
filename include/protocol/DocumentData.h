...
namespace editor {
    class DocumentData {
        ...
        QHash<QString,int> site_id_others_;         // for all other users with access to the document
        QHash<QString,Profile> profile_others_;     // for all other users with access to the document
