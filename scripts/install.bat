...
echo Set oLink = oWS.CreateShortcut(DesktopPath ^& "\Real-time Collaborative Text Editor.lnk") >> ClientShortcut.vbs
echo oLink.Arguments = "localhost 5000" >> ClientShortcut.vbs
echo oLink.Description = "Real-time Collaborative Text Editor" >> ClientShortcut.vbs
